...
const (
	...
	InventoryService_DecreaseStock_FullMethodName = "/InventoryService/DecreaseStock"
)
...
func (c *inventoryServiceClient) DecreaseStock(ctx context.Context, in *DecreaseStockRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedInventoryServiceServer) DecreaseStock(context.Context, *DecreaseStockRequest) (*emptypb.Empty, error) {
