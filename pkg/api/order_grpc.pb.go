...
const (
	...
	OrderService_OrdersList_FullMethodName  = "/OrderService/OrdersList"
)
...
type OrderServiceClient interface {
	...
	OrdersList(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*OrdersListResponse, error)
}
...
func (c *orderServiceClient) OrdersList(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*OrdersListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(OrdersListResponse)
	err := c.cc.Invoke(ctx, OrderService_OrdersList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServiceServer interface {
	...
	OrdersList(context.Context, *Empty) (*OrdersListResponse, error)
...
func (UnimplementedOrderServiceServer) OrdersList(context.Context, *Empty) (*OrdersListResponse, error) {
...
func _OrderService_OrdersList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServiceServer).OrdersList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrderService_OrdersList_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).OrdersList(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var OrderService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _OrderService_OrdersList_Handler,
		},
	},
